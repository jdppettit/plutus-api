defmodule PlutusWeb.OnceOffView do
  ...
  def render("once_offs.json", %{once_offs: once_offs}) do
    parsed_once_offs = once_offs
    |> Enum.map(fn once_off -> 
      %{
    ...
    %{
      message: "once offs retrieved successfully",
      once_offs: parsed_once_offs
    }
  end
